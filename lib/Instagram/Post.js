...
class Post {
    ...
    async publishPost(page, username, postDetails, type = 'video') {
        ...
        await page.waitForSelector('[class="_aacl _aacr _aact _aacx _aad6 _aadb"]', { timeout: this.browserTimeout * 2 });
    ...
    async setPostSize(page, username, postDetails, type) {
        ...
        if (type == 'video')
            await this.uploadVideo(page, username, postDetails);
        else
            return;
    ...
    async uploadVideo(page, username, postDetails) {
        ...
        await page.waitForSelector('button[class="_acan _acao _acas"]', { timeout: this.browserTimeout });
    ...
    async openUploadPopup(page, username) {
        ...
        await page.waitForSelector('a[href="/accounts/edit/"]', { timeout: this.browserTimeout });
    ...
    async open(page, username) {
        ...
        await page.goto(`https://www.instagram.com/${username}`, { timeout: this.browserTimeout });
